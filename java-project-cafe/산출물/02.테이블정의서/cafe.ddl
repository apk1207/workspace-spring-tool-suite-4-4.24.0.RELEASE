...
ALTER TABLE cart ADD CONSTRAINT IDX_cart_FK1 FOREIGN KEY (userid) REFERENCES users (userid) ON DELETE CASCADE;

ALTER TABLE orders ADD CONSTRAINT IDX_orders_PK PRIMARY KEY (o_no);
ALTER TABLE orders ADD CONSTRAINT IDX_orders_FK0 FOREIGN KEY (userid) REFERENCES users (userid) ON DELETE CASCADE;
