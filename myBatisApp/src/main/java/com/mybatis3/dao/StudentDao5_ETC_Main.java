...
public class StudentDao5_ETC_Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("---------findStudentByNameLike----------");
		System.out.println(studentDao.findStudentByNameLike("시"));
		...
		Student firstStudent= Student.builder().studId(1).build();
		Student secondStudent=Student.builder().studId(2).build();
		Student thirdStudent= Student.builder().studId(5).build();
