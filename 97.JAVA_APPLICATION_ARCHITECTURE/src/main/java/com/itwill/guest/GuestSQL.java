...
public class GuestSQL {
	...
	public static final String GUEST_SELECT_BY_NAME = "select * from guest where guest_name like '%'||?||'%' order by guest_date desc";
	public static final String GUEST_SELECT_BY_TITLE = "select * from guest where guest_title like '%'||?||'%' order by guest_date desc";
	public static final String GUEST_SELECT_BY_CONTENT = "select * from guest where guest_content like '%'||?||'%' order by guest_date desc";
