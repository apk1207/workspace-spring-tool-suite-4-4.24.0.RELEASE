	...
	if(cookies!=null){
		for(Cookie cookie:cookies){
			if(cookie.getName().equals("searchKeyword")){
				...
				System.out.println("["+request.getRemoteAddr()+"]가 전송한쿠키이름:"+cookie.getName());
				System.out.println("["+request.getRemoteAddr()+"]가 전송한쿠키값:"+cookie.getValue());
			}
		}
...
<body>
<h1>쿠키읽기</h1><hr/>
	<form action="7-0.cookie_create.jsp" method="get">
